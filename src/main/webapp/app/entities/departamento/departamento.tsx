...
export const Departamento = (props: IDepartamentoProps) => {
  useEffect(() => {
    props.getEntities();
  }, []);

  const { departamentoList, match, loading } = props;
  return (
    <div>
      <h2 id="departamento-heading">
        <Translate contentKey="ucentralEventosApplicationApp.departamento.home.title">Departamentos</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="ucentralEventosApplicationApp.departamento.home.createLabel">Create new Departamento</Translate>
        </Link>
      </h2>
        ...
        {departamentoList && departamentoList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ucentralEventosApplicationApp.departamento.home.notFound">No Departamentos found</Translate>
            </div>
          )
        )}
      </div>
