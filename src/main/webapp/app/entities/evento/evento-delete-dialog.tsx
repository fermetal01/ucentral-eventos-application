...
export const EventoDeleteDialog = (props: IEventoDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ucentralEventosApplicationApp.evento.delete.question">
        <Translate contentKey="ucentralEventosApplicationApp.evento.delete.question" interpolate={{ id: eventoEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-evento" color="danger" onClick={confirmDelete}>
